...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  Email: \href{mailto:luke123halley@gmail.com}{\uline{luke123halley@gmail.com}} $|$ % row = 2, col = 2
...
\section{Summary}
\small{
  DevOps Engineer with 5+ years of experience in optimizing DevOps pipelines, continuous deployments, and cloud infrastructure migrations. Proficient in AWS, recognized for technical excellence, and holding a first-class honors BSc in the Internet of Things. Currently at Mineral Resources, designing scalable cloud solutions and automation frameworks. Relocating to Sydney on 24th February due to my partner’s job offer and available for a remote first interview.
}
%--------------------------------------------
