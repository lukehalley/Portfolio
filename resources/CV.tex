...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  Email: \href{mailto:development@lukehalley.com}{\uline{development@lukehalley.com}} $|$ % row = 2, col = 2
...
\section{Summary}
\small{
  DevOps Engineer with 5+ years of experience in optimizing DevOps pipelines, continuous deployments, and cloud infrastructure migrations. Proficient in AWS and Azure, recognized for technical excellence, and holding a first-class honors BSc in the Internet of Things. Current role details available on request.
}
%--------------------------------------------
...
\resumeHeadingListStart{}
  ...
  {Current role -- details on request}{Perth, Australia}
    \resumeItemListStart{}
      \resumeItem{Designing and delivering multi-cloud infrastructure across AWS and Azure using Terraform and CI/CD pipelines. Further details available on request.}
    \resumeItemListEnd{}
