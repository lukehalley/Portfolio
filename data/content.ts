  ...
  current: {
    ...
    highlights: [
      ...
      },
      {
        ...
        impact: "2-week → 2-hour account setup",
...
export const skills = {
  "Infrastructure as Code": [
    { name: "Terraform / OpenTofu", highlight: "95 AWS accounts" },
    { name: "CloudFormation" },
    { name: "AWS CDK" },
    { name: "Checkov / tfsec", highlight: "Security scanning" },
    { name: "OPA / Sentinel", highlight: "Policy as code" },
  ],
  "Cloud Platforms": [
    { name: "AWS", highlight: "Solutions Architect certified" },
  ...
  "CI/CD & Automation": [
    ...
    { name: "GitLab CI", highlight: "200+ repos migrated" },
    { name: "Octopus Deploy" },
    { name: "Jenkins" },
    { name: "Step Functions", highlight: "Workflow orchestration" },
  ],
  "Containers & Compute": [
    { name: "Docker" },
    { name: "ECS / Fargate", highlight: "50% cost reduction" },
  ...
  "Data & Databases": [
    { name: "RDS / Aurora", highlight: "Multi-environment migrations" },
    { name: "DMS", highlight: "Blue-green cutovers" },
    { name: "Redshift" },
    { name: "DynamoDB" },
    { name: "SQS / SNS" },
  ],
  "Storage & Backup": [
    { name: "S3", highlight: "Lifecycle & replication" },
    { name: "EFS" },
    { name: "EBS" },
    { name: "S3 Glacier" },
    { name: "AWS Backup", highlight: "Cross-region DR" },
  ],
  "FinOps": [
    { name: "Cost Explorer" },
    { name: "AWS Budgets" },
    { name: "Tagging Strategies", highlight: "Cost allocation" },
  ],
  "Scripting": [
    { name: "PowerShell", highlight: "Primary language" },
    { name: "Python" },
    { name: "Bash" },
    { name: "Go" },
  ],
  ...
  professional: [
    {
      ...
      impact: "95 AWS accounts • 2-week → 2-hour provisioning",
      featured: true,
